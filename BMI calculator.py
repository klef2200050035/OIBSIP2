...
Label_height = tk.Label(frame_height, text="Enter your Height(m)", bg=heightWeight_co, fg="black",
                        font=("Garamond", 14, "roman"))
...
Label_weight = tk.Label(frame_weight, text="Enter your Weight(kg)", bg=heightWeight_co, fg="black",
                        font=("Garamond", 14, "roman"))
